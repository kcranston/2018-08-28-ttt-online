...
# latlng: "-48.876667,-123.393333 "       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use http://www.latlong.net/)
...
instructor: ["Karen Cranston", "Jason Williams"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["N/A"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["karen.cranston@gmail.com", "smcclatchy1@gmail.com", "sheena.murphy@mail.wvu.edu", "pschloss@umich.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
etherpad: https://pad.carpentries.org/2018-08-28-ttt-online            # optional: URL for the workshop Etherpad if there is one
...
<p id="contact">
  ...
  {% else %}
    to-be-announced
  {% endif %}
  for more information. Ask Karen if you have questions about the course contents, or preparation you need to do in advance. Email your local organizer (Sue at Jackson Labs, Sheena at WVU, and Pat at UMich) if you have questions about local logistics.
</p>
